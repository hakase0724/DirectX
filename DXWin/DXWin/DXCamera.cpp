...
MyDirectX::DXCamera::DXCamera(CameraParam *param)
{
	mParam = *param;
}
...
DirectX::XMMATRIX MyDirectX::DXCamera::GetDXCameraParam(TRANSFORM transform)
{
	...
	return XMMatrixTranspose(scale * move * worldX * worldY * worldZ * view * proj);
}
...
void MyDirectX::DXCamera::SetRotation(float x, float y)
{
	mParam.mXRote = x;
	mParam.mYRote = y;
}

void MyDirectX::DXCamera::SetPos(float x, float y, float z)
{
